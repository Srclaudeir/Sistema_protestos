...
const getContratos = async (req, res) => {
  try {
    ...
    const allowedSortFields = ['id', 'numero_contrato_sisbr', 'numero_contrato_legado', 'especie', 'ponto_atendimento', 'created_at'];
    
    // Parse sort parameters
    const sort = parseSortParams(req.query, allowedSortFields) || [['created_at', 'DESC']];
    
    // Define allowed filter fields
    const allowedFilterFields = ['cliente_id', 'especie', 'ponto_atendimento', 'numero_contrato_sisbr', 'numero_contrato_legado'];
...
const updateContrato = async (req, res) => {
  try {
    const { id } = req.params;
    const { numero_contrato_sisbr, numero_contrato_legado, especie, ponto_atendimento, cliente_id } = req.body;
    ...
    await contrato.update({
      numero_contrato_sisbr: numero_contrato_sisbr || contrato.numero_contrato_sisbr,
      numero_contrato_legado: numero_contrato_legado || contrato.numero_contrato_legado,
